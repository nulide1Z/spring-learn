...
import cn.wyw.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor;
...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public void doScan(String... basePackages) {
        ...
        // 注册 autowired 和 value的bean
        register.registerBeanDefinition("cn.wyw.springframework.context.annotation.internalAutowiredAnnotationProcessor", new BeanDefinition(AutowiredAnnotationBeanPostProcessor.class));
    }
